...
@NgModule({
  declarations: [FinanzasComponent, TablaFacturasComponent, DialogPagarComponent, ZelleComponent, PagoMovilComponent, CardDatosPagoComponent, TransferenciaComponent],
  imports: [
    CommonModule,
